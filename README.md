...
**The agent composer** — describe the work; Crafterm files the ticket, creates the
worktree and starts Claude inside it.

<img src="docs/images/agent-composer.gif" alt="Agent composer: typing a prompt and opening the slash menu" width="860" />

**Terminals & splits** — real login shells, split as deep as you like.

<img src="docs/images/terminals-splits.gif" alt="Running git log and npm test in split terminal panes" width="860" />

**Spotlight** — one search box over files, commands, terminals, plans and projects.

<img src="docs/images/spotlight.gif" alt="Spotlight searching across tabs, then the command palette" width="860" />

**Daily plan** — the kanban board that the composer files tickets into.

<img src="docs/images/daily-plan.gif" alt="Dragging a ticket across the daily plan board" width="860" />

</div>

> Every recording above is generated by `npm run screenshots` against a throwaway
> demo workspace — see [Screenshots & GIFs](#screenshots--gifs).
...
<img src="docs/images/agent-composer.gif" alt="Agent composer" width="820" />
...
<img src="docs/images/daily-plan.gif" alt="Daily plan kanban board" width="820" />
...
<img src="docs/images/terminals-splits.gif" alt="Split terminal panes running real commands" width="820" />
...
<img src="docs/images/sidebar.gif" alt="Sidebar tree with projects, worktrees and a row context menu" width="820" />
...
<img src="docs/images/spotlight.gif" alt="Spotlight and the command palette" width="820" />
...
<img src="docs/images/claude.gif" alt="Claude sessions picker and the Claude tab in Spotlight" width="820" />
...
<img src="docs/images/worktrees.gif" alt="Creating a git worktree from the sidebar" width="820" />
...
<img src="docs/images/ios-worktrees.gif" alt="Build and run menu on an iOS worktree row" width="820" />
...
- **Docker panel** — containers, images, volumes, networks, compose projects and
  ...
  <img src="docs/images/docker.gif" alt="Docker panel listing containers, images, volumes and networks" width="820" />
...
- **Database workbench** — saved connections (Postgres / MySQL / SQLite), an
  ...
  <img src="docs/images/database.gif" alt="Running a SQL query and reading the result grid" width="820" />
...
- **PR panel** — open pull requests, workflow runs and deployments across your
  ...
  <img src="docs/images/pull-requests.gif" alt="Pull request cards and the diff pane" width="820" />
- **Code panes** — a Monaco editor with go-to-definition wired into the pane
  system, plus a diff pane for reviewing changes.

### 📓 Notebook

<img src="docs/images/notebook.gif" alt="Notebook mode: a markdown note, the compact board and meeting notes" width="820" />
...
<img src="docs/images/right-panel.gif" alt="Right-side panel: alerts, reminders, files, time and bookmarks" width="820" />
...
<img src="docs/images/notifications.gif" alt="Grouped notification cards and the status/project filter chips" width="820" />
...
<img src="docs/images/theming.gif" alt="Switching themes live, then the custom ANSI palette" width="820" />
...
<img src="docs/images/code-and-docs.gif" alt="Opening a source file in a code pane and a markdown file in a doc pane" width="820" />
...
<img src="docs/images/improve.gif" alt="The Improve todo editor with its Todo / Ready to test / Done tabs" width="820" />
...
Every image in this README is generated — none are hand-captured:

```bash
npm run screenshots   # builds the app, records docs/images/*.gif (needs ffmpeg)
```

`scripts/screenshots/` builds a throwaway workspace under `/tmp/crafterm-demo` —
two real git repos with real history and real worktrees, a seeded
`crafterm-state.json`, a notebook, a SQLite database, and stub `gh` / `docker`
binaries — then launches the real Electron build against it and drives each feature
with Playwright, capturing frames that `ffmpeg` encodes into a GIF. The terminals
run real commands; nothing about the output is faked.

Nothing from the machine that runs it reaches a frame: the demo shell has an
anonymous prompt, the command palette reads a demo `.zshrc`, `gh`/`docker`/Claude
data is stubbed, and every recording ends with a guard that fails the run if the
home path or username appears anywhere in the UI.
