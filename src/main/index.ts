...
import * as claudeAccount from './services/claude-account.service'
...
// Real ("server-side") Claude usage (keychain credential + OAuth usage endpoint)
// lives in services/claude-account.service.ts.
ipcMain.handle(
  'claude:realUsage',
