import { watch as fsWatch, type FSWatcher, readFileSync, writeFileSync, mkdirSync } from 'fs'
...
function writeCounters(file: string, counters: Record<string, number>): void {
  try {
