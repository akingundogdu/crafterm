...
// consumers keep their imports). The gea panel mounts into the sidebar tab-list
// host; the store singleton keeps the sub-tab + search state across remounts.
// `.docker-mode` on the host gives the flex-column layout (the gea root is
// display:contents).
