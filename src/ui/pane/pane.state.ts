import type { ProjectCommand, ProjectNode, Application, BrowserPane } from '@ui/types/types'
import type { DropZoneName, PaneMenuEntry } from './pane.types'
import { panes, paneActions, state } from '@ui/state/state'
import { findTabByPane, panesInLayout } from '@ui/tree/tree'
import { findProjectById, findApp, flattenProjects } from '@ui/catalog/catalog'
