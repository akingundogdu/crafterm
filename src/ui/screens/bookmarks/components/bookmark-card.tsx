    ...
    <div class="bookmarks-card">
      ...
      <div class="bookmarks-actions">
        {bm.type === 'link'
          ...
          : createButton({ text: 'Copy', className: 'bookmarks-act primary', onClick: makeCopyClick(bm) })}
        {createButton({ text: 'Remind', className: 'bookmarks-act', onClick: makeRemindClick(bm) })}
        {createButton({
