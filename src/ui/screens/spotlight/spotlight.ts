...
import { buildGlobalSearchIndex, type GsEntry } from '../pickers/global-search/global-search'
...
export async function showSpotlight(initialTab = 'all'): Promise<void> {
  ...
  overlay.addEventListener('mousedown', makeOverlayBackdropClose(overlay, close))
