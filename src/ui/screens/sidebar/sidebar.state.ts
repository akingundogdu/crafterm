...
import { allTabs, panesInLayout, firstPaneOf, ancestorFolders } from '@ui/tree/tree'
...
import { showProjectPicker } from '../pickers/project/project'
...
import { showRunningProcessesDashboard, showRunningDevicesDashboard } from '../pickers/processes/processes'
