import type { SidebarNode, FolderNode, ProjectNode } from '@ui/types/types'
import { UITexts } from '@texts'
import { startBackgroundProcess } from '@services/bgproc'
import { state, settings, paneActions } from '@ui/state/state'
import { persistence } from '@repositories/persistence.service'
import { ancestorFolders } from '@ui/tree/tree'
import {
  selectTab,
  closeTab,
  togglePin,
...
import { iosWorktreeMenuItems } from '../../ios-worktree/ios-worktree'
